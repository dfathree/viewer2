...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { bookmark_num: @bookmark.bookmark_num, thre_id: @bookmark.thre_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { bookmark_num: @bookmark.bookmark_num, thre_id: @bookmark.thre_id } }
